...
def test_get_start_stop_description_no_trips():
    duty_times_data = {
        "duty_id": [1, 2],
    }
    duty_times_df = pd.DataFrame(duty_times_data)
    ...
    expected_data = {
        "duty_id": [1, 2],
        "first_stop_description": ["No description", "No description"],
        "last_stop_description": ["No description", "No description"],
    }
...
def test_get_start_stop_description_no_stops():
    duty_times_data = {
        "duty_id": [1, 2],
    }
    duty_times_df = pd.DataFrame(duty_times_data)
